...
def _draw_army_icon(
    ...
    # icons.py is at: src/rendering/icons.py
    # icons are at: icons/army.png
    current_file = os.path.abspath(__file__)
    # Go up from src/rendering/icons.py to src, then to the repository root, then to icons
