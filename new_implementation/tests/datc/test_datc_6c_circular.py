...
reference resolver in the legacy tree (semantics only; no code copied; `git show v2.7.68:old_implementation/diplomacy/tests/test_datc.py` if a case is ever disputed).
"""
