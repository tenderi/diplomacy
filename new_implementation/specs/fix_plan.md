...
- [x] **Game replay system** - Historical game state viewing and analysis (implemented and tested July 2025)
...
- Game replay system: Historical game state snapshots are stored after each phase/turn, accessible via API and Telegram bot. Fully tested.
