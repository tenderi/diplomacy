...
2. When you discover a parser, lexer, control flow or LLVM issue. Immediately update @fix_plan.md with your findings. When the issue is resolved, update @fix_plan.md and remove the item.
...
9999999999. ALWAYS KEEP @fix_plan.md up to do date with your learnings. Especially after wrapping up/finishing your turn.
