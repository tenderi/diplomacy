...
def generate_default_map() -> bytes:
    ...
    svg_path = os.environ.get("DIPLOMACY_MAP_PATH", "maps/standard_cleaned.svg")
...
async def map_command(update: Update, context: ContextTypes.DEFAULT_TYPE) -> None:
    ...
    try:
        ...
        base_map_path = os.environ.get("DIPLOMACY_MAP_PATH", "maps/standard_cleaned.svg").replace("standard_cleaned.svg", "")
