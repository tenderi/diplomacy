...
from src.engine.order_parser import OrderParser, OrderParseError, OrderValidationError
...
def test_database_operations():
    ...
    # Create schema first
    from src.engine.database import create_database_schema
...
def test_order_creation_and_validation():
    ...
    # Test invalid order (non-adjacent move)
    parsed_invalid = parser.parse_order_text("A PAR - MAR", "FRANCE")
    try:
        ...
        assert "not adjacent" in reason.lower()
